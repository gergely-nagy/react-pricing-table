...
var StyleElement = __webpack_require__(33)
...
var propTypes = {
  strikethrough: _propTypes2.default.bool,
...
var propTypes = {
    ...
    titleAccessor: _propTypes2.default.oneOfType([_propTypes2.default.node, _propTypes2.default.func]),
    priceText: _propTypes2.default.string,
    priceAccessor: _propTypes2.default.oneOfType([_propTypes2.default.node, _propTypes2.default.func]),
    buttonClass: _propTypes2.default.string,
    buttonText: _propTypes2.default.string,
    children: _propTypes2.default.node,
    highlightColor: _propTypes2.default.string,
    shouldDisplayButton: _propTypes2.default.bool
};
    ...
    _createClass(PricingSlot, [{
        ...
        value: function render() {
            var _props = this.props,
                ...
                shouldDisplayButton = _props.shouldDisplayButton,
                Title = _props.titleAccessor,
                Price = _props.priceAccessor;
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    Price ? _react2.default.createElement(Price, { className: "tag", text: this.props.priceText }) : _react2.default.createElement(
                        "li",
                        { className: "tag" },
                        this.props.priceText
                    ),
                    this.props.children,
                    shouldDisplayButton && _react2.default.createElement(
                        "li",
                        { className: "grey" },
                        _react2.default.createElement(
                            _Button2.default,
...
exports.PricingDetail = exports.PricingSlot = exports.PricingTable = undefined;

__webpack_require__(26);

__webpack_require__(27);

var _PricingTable = __webpack_require__(25);

var _PricingTable2 = _interopRequireDefault(_PricingTable);

var _PricingSlot = __webpack_require__(24);

var _PricingSlot2 = _interopRequireDefault(_PricingSlot);

var _PricingDetail = __webpack_require__(23);

var _PricingDetail2 = _interopRequireDefault(_PricingDetail);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

if (typeof window !== 'undefined') {
  window.PricingTable = _PricingTable2.default;
  window.PricingSlot = _PricingSlot2.default;
  window.PricingDetail = _PricingDetail2.default;
}

exports.PricingTable = _PricingTable2.default;
exports.PricingSlot = _PricingSlot2.default;
exports.PricingDetail = _PricingDetail2.default;
